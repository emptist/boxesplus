...
# 这是一个 LitCoffee 文件 - 文档和代码共存
    ...
    { titleSlide, listSlide, cardSlide, tableSlide, quoteSlide, chartSlide, THEME } = require "../api/boxesplus-artist.js"
...
## 保存文件
    ...
    pres.writeFile({ fileName: "../outputs/C01测试.pptx" })
      .then -> console.log "✅ Created: C01测试.pptx"
