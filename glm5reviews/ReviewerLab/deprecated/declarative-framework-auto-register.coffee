...
# 利用 CoffeeScript 独特特性：类定义时代码会执行
...
class Slide
    # CoffeeScript 独特特性：
    # 类定义时，这个代码块会执行
    console.log "📝 Slide base class defined"

class Section
    console.log "📝 Section base class defined"

class Chapter
    console.log "📝 Chapter base class defined"

class Presentation
    console.log "📝 Presentation base class defined"

# ============================================
# 自动注册函数（利用 CoffeeScript 独特特性）
# ============================================

registerSlide = (klass) ->
    global.__boxesplus_registry__.slides.push(klass)
    console.log "✅ Auto-registered slide: #{klass.name}"
    klass

registerSection = (klass) ->
    global.__boxesplus_registry__.sections.push(klass)
    console.log "✅ Auto-registered section: #{klass.name}"
    klass

registerChapter = (klass) ->
    global.__boxesplus_registry__.chapters.push(klass)
    console.log "✅ Auto-registered chapter: #{klass.name}"
    klass

registerPresentation = (klass) ->
    global.__boxesplus_registry__.presentations.push(klass)
    console.log "✅ Auto-registered presentation: #{klass.name}"
    klass
...
# ============================================
# 测试 CoffeeScript 独特特性
# ============================================

if require.main is module
    console.log "\n=== CoffeeScript Unique Feature Demo ===\n"
    console.log "CoffeeScript 类定义是动态的，不是静态的！"
    console.log "当定义类时，代码就会执行。\n"
    
    # 用户定义的幻灯片
    # 利用 CoffeeScript 独特特性：类定义后立即执行代码
