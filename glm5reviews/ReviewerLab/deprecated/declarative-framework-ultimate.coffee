...
global.__boxesplus_presentations__ = []
...
class Presentation
    ...
    # 当子类定义时，这段代码会执行
    console.log "📝 Presentation subclass defined: #{@name}" if @name?
...
setImmediate ->
    presentations = global.__boxesplus_presentations__
