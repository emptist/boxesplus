# F05 数据资产管理课程 - 完整演示
# 使用 ReviewerLab 的最佳幻灯片类型

{ 
  Slide, TitleSlide, ContentSlide, TwoColumnSlide, TableSlide, CardSlide, 
  ComparisonSlide, ProcessSlide, MatrixSlide, Section, Presentation
...
class 数据资产管理八要素 extends CardSlide
...
class 医院数据类型 extends CardSlide
  @临床数据: "病历、检验、检查、用药——核心资产"
  @运营数据: "门诊、住院、设备——管理基础"
  @管理数据: "人事、财务、行政——决策支撑"
  @研究数据: "临床研究、样本数据——创新源泉"

class 医院数据价值 extends CardSlide
  @临床价值: "辅助诊断、精准医疗、疾病预测"
  @管理价值: "运营分析，质量监控、绩效评价"
...
class 数据安全体系 extends CardSlide
...
class 临床数据应用 extends CardSlide
  @辅助诊断: "AI影像识别、智能读片"
  @精准医疗: "基因检测、个体化治疗"
  @决策支持: "诊疗建议、风险预警"

class 管理数据应用 extends CardSlide
  @运营分析: "业务量、收入结构、成本效益"
  @质量监控: "医疗质量、护理质量、院感监控"
  @决策支持: "院长驾驶舱、科室运营分析"
...
class 课程特色 extends ContentSlide
  @前沿性强: "紧跟AI和数据经济发展趋势"
  @体系完整: "普遍意义+医疗行业聚焦"
  @实用性强: "可直接使用的管理框架和方法"

class 工具箱 extends CardSlide
  @工具一: "数据资产目录模板"
  @工具二: "数据治理制度框架"
  @工具三: "数据安全检查清单"
  @工具四: "合规风险评估表"
