...
# C01课程图表 - 完整版（HTML + PDF + PPTX）
# 使用完整的转换流程：生成HTML → 转换为PDF/PPTX

{ 
  开始绘图HTML, 完成绘图, 生成PDF, 生成PPTX, 生成所有格式
  创建流程图, 创建时序图, 创建类图, 创建状态图 
} = require "../api/mermaid-enhanced-complete.coffee"
...
console.log "\n========================================"
console.log "步骤1：生成HTML"
console.log "========================================\n"

绘图HTML = 开始绘图HTML "C01医疗质量与安全管理课程图表（完整版）"
...
htmlPath = 完成绘图 "../output/C01课程图表-完整版.html"
...
console.log "\n========================================"
console.log "步骤2：转换为PDF和PPTX"
console.log "========================================\n"

pdfPath = htmlPath.replace(".html", ".pdf")
pptxPath = htmlPath.replace(".html", ".pptx")

do ->
  await 生成所有格式 htmlPath, pdfPath, pptxPath
  
  console.log "\n========================================"
  console.log "✅ 全部完成！"
  console.log "========================================"
  console.log "生成的文件："
  console.log "  1. HTML: #{htmlPath}"
  console.log "  2. PDF:  #{pdfPath}"
  console.log "  3. PPTX: #{pptxPath}"
  console.log "\n说明："
  console.log "  • HTML版本：使用RevealJS，支持交互和导航"
  console.log "  • PDF版本：适合打印和分发"
  console.log "  • PPTX版本：通过截图方式嵌入图表，保持视觉效果"
